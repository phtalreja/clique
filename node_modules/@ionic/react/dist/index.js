...
const hydrate = require('@ionic/core/hydrate');
...
async function ionRenderToString(html, userAgent, options = {}) {
    ...
    const ionHtml = await hydrate.renderToString(html, renderToStringOptions);
    return ionHtml.html;
}
...
class PageManager extends React__default.PureComponent {
    constructor(props) {
        super(props);
        this.ionPageElementRef = this.props.forwardedRef || React__default.createRef();
    }
    componentDidMount() {
    ...
    render() {
        ...
        return (React__default.createElement(IonLifeCycleContext.Consumer, null, context => {
            ...
            return (React__default.createElement("div", Object.assign({ className: className ? `${className} ion-page ${hidePageClass}` : `ion-page ${hidePageClass}`, ref: this.ionPageElementRef }, props), children));
        }));
    }
    static get contextType() {
        return StackContext;
...
const IonTabsContext = React__default.createContext({
    activeTab: undefined,
    selectTab: () => false
});
...
class IonTabButton extends React__default.Component {
    constructor(props) {
        super(props);
...
class IonTabs extends React__default.Component {
    constructor(props) {
        ...
        this.tabBarRef = React__default.createRef();
    ...
    render() {
        ...
        const children = typeof this.props.children === 'function' ?
            this.props.children(this.ionTabContextState) : this.props.children;
        React__default.Children.forEach(children, (child) => {
            if (child == null || typeof child !== 'object' || !child.hasOwnProperty('type')) {
                return;
            }
            if (child.type === IonRouterOutlet) {
                outlet = React__default.cloneElement(child, { tabs: true });
            }
            ...
            if (child.type === IonTabBar) {
                ...
                tabBar = React__default.cloneElement(child, {
                    onIonTabsDidChange,
                    onIonTabsWillChange,
                    ref: this.tabBarRef
                });
                ...
                const { onIonTabsDidChange, onIonTabsWillChange } = this.props;
                tabBar = React__default.cloneElement(child.props.children[1], {
                    onIonTabsDidChange,
                    onIonTabsWillChange,
                    ref: this.tabBarRef
                });
        ...
        return (React__default.createElement(IonTabsContext.Provider, { value: this.ionTabContextState }, this.context.hasIonicRouter() ? (React__default.createElement(PageManager, Object.assign({ className: className ? `${className}` : '', routeInfo: this.context.routeInfo }, props),
            React__default.createElement("ion-tabs", { className: "ion-tabs", style: hostStyles },
                tabBar.props.slot === 'top' ? tabBar : null,
                React__default.createElement("div", { style: tabsInner, className: "tabs-inner" }, outlet),
                tabBar.props.slot === 'bottom' ? tabBar : null))) : (React__default.createElement("div", Object.assign({ className: className ? `${className}` : 'ion-tabs' }, props, { style: hostStyles }),
            tabBar.props.slot === 'top' ? tabBar : null,
            React__default.createElement("div", { style: tabsInner, className: "tabs-inner" }, outlet),
...
exports.ionRenderToString = ionRenderToString;
