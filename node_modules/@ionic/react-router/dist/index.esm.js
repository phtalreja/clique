    ...
    handleHistoryChange(location, action) {
        ...
        if (leavingUrl !== location.pathname) {
            ...
            if ((_c = this.incomingRouteParams) === null || _c === void 0 ? void 0 : _c.id) {
                ...
                routeInfo = Object.assign(Object.assign({ id: generateId('routeInfo') }, this.incomingRouteParams), { lastPathname: leavingLocationInfo.pathname, pathname: location.pathname, search: location.search, params: this.props.match.params });
                if (isPushed) {
