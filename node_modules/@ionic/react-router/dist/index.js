...
class IonRouteInner extends React.PureComponent {
    render() {
        return (React.createElement(reactRouter.Route, { path: this.props.path, exact: this.props.exact, render: this.props.render, computedMatch: this.props.computedMatch }));
    }
}
    ...
    getChildrenToRender(outletId, ionRouterOutlet, routeInfo) {
        ...
        const children = viewItems.map(viewItem => {
            ...
            if (viewItem.ionRoute && !viewItem.disableIonPageManagement) {
                clonedChild = (React.createElement(react.ViewLifeCycleManager, { key: `view-${viewItem.id}`, mount: viewItem.mount, removeView: () => this.remove(viewItem) }, React.cloneElement(viewItem.reactElement, {
...
class StackManager extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(react.StackContext.Provider, { value: this.stackContextValue }, React.cloneElement(ionRouterOutlet, {
            ref: (node) => {
    ...
    handleHistoryChange(location, action) {
        ...
        if (leavingUrl !== location.pathname) {
            ...
            if ((_c = this.incomingRouteParams) === null || _c === void 0 ? void 0 : _c.id) {
                ...
                routeInfo = Object.assign(Object.assign({ id: react.generateId('routeInfo') }, this.incomingRouteParams), { lastPathname: leavingLocationInfo.pathname, pathname: location.pathname, search: location.search, params: this.props.match.params });
                if (isPushed) {
...
class IonReactRouter extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(reactRouterDom.Router, Object.assign({ history: this.history }, props),
...
class IonReactMemoryRouter extends React.Component {
    ...
    render() {
        const _a = this.props, { children } = _a, props = tslib.__rest(_a, ["children"]);
        return (React.createElement(reactRouter.Router, Object.assign({}, props),
            React.createElement(IonRouter, { registerHistoryListener: this.registerHistoryListener }, children)));
    }
}
