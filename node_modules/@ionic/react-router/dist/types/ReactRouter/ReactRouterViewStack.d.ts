...
export declare class ReactRouterViewStack extends ViewStacks {
    ...
    findLeavingViewItemByRouteInfo(routeInfo: RouteInfo, outletId?: string): ViewItem<any> | undefined;
    getViewItemForTransition(pathname: string): ViewItem<any> | undefined;
